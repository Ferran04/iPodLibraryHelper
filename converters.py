...
class ConversionStrategy(ABC):
    @abstractmethod
    def convert(self, source_file: str, picture_path: str, target_file_base: str) -> None:
    ...
    def convert(self, source_file: str, picture_path: str, target_file_base: str) -> None:
        ...
        try:
            ...
            if picture_path is not None:
                ...
                with open(picture_path, 'rb') as cover:
                    audio.tags['covr'] = [MP4Cover(cover.read(), imageformat=MP4Cover.FORMAT_JPEG)]
                audio.save()
...
class Converter:
    ...
    def convert(self, source_file: str, picture_path: str, target_file: str) -> None:
        self.strategy.convert(source_file, picture_path, target_file)
        return
